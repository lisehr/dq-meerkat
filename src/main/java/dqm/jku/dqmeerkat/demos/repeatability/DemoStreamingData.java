...
public class DemoStreamingData {
    ...
    public static void main(String args[]) throws IOException, InterruptedException, NoSuchMethodException {
        ...
        ConnectorCSV conn = FileSelectionUtil.getConnectorCSV(
                "src/main/resource/data/humidity.csv"
        );
        ...
        for (Concept c : ds.getConcepts()) {
            // actual data from Data source (here 5000 samples)
            RecordList rs = conn.getPartialRecordList(c, 0, 5000);
            for (Attribute a : c.getSortedAttributes()) { // generation of Reference data profile
        ...
        //TODO verification of generated domain expert?
        var ret = evualuateRDPs(ds);
    ...
    private static boolean evualuateRDPs(Datasource ds) {
        // TODO

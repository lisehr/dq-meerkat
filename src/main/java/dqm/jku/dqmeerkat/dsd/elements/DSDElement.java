...
public abstract class DSDElement implements Serializable, Comparable<DSDElement> {
    ...
    /**
     * Creates a {@link DataProfile}, that acts as the Reference DataProfile and annotates this element with it.
     * The {@link DataProfile} is generated by using the default ({@link FullSkeletonGenerator}) generator.
     *
     * @param rs the list of data used for generating the reference data profile
    ...
    /**
     * Creates a {@link DataProfile}, that acts as the Reference DataProfile and annotates this element with it.
     * The {@link DataProfile} is generated by using the given {@link DataProfileSkeletonGenerator}
     *
     * @param rs        the list of data used for generating the reference data profile
     * @param generator the {@link DataProfileSkeletonGenerator}s used to create the {@link DataProfile}s used statistics
     * @throws NoSuchMethodException
     */
     ...
     * The {@link DataProfile} is generated by using the default ({@link FullSkeletonGenerator}) generator.
     *
     * @param records  the list of data used for generating the reference data profile
     * @param filePath path to the file containing pattern matching definitions
     * @throws NoSuchMethodException
     */
     ...
     * @throws NoSuchMethodException
     */
    public void annotateProfile(RecordList records, String filePath, DataProfileSkeletonGenerator generator) throws NoSuchMethodException {
        dataProfile = new DataProfile(records, this, generator);
    }

...
public class InfluxDBConnectionV1 implements InfluxDBConnection {
    ...
    public InfluxDBConnectionV1(String dbName) {
        instance = InfluxDBFactory.connect(URL, USER, PW);
        this.dbName = dbName;
        this.retentionPolicyName = DEF_RET;
        createDB();
    ...
    public InfluxDBConnectionV1(String dbName, String retentionPolicyName) {
        instance = InfluxDBFactory.connect(URL, USER, PW);
        this.dbName = dbName;
    ...
    public void write(String bucketName, Point measurement) {
        throw new UnsupportedOperationException("buckets are not used in this implementation!");
    }

...
public class ConnectorMongoDBSimple extends DSConnector {
    ...
    public ConnectorMongoDBSimple(String DBUrl, int DBPort, String DBName, String DBuser, String DBpw, String userDBName) {
    ...
    public ConnectorMongoDBSimple(String DBUrl, int DBPort, String DBName, String DBuser, String DBpw) {
        this(DBUrl, DBPort, DBName, DBuser, DBpw, DBName);
    }

    public ConnectorMongoDBSimple(String DBUrl, String DBName, String DBuser, String DBpw) throws UnknownHostException {
        this(DBUrl, DEFAULT_PORT, DBName, DBuser, DBpw, DEFAULT_USER_DB);
    }

    public ConnectorMongoDBSimple(String DBUrl, int DBPort) {
    ...
    public ConnectorMongoDBSimple(String DBUrl) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ConnectorMongoDBSimple connector = new ConnectorMongoDBSimple("localhost", "sample_training", "admin", "adminpw");

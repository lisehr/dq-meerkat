...
public enum StatisticTitle {
  ...
  /**
   * Title for {@link dqm.jku.dqmeerkat.quality.profilingstatistics.singlecolumn.datatypeinfo.BasicType}
   */
  bt("Basic type"),
  dt("Data type"),
  ...
  private StatisticTitle(String label) {
    this.label = label;
  }

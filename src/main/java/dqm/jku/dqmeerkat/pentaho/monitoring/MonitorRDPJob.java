...
public class MonitorRDPJob extends JobEntryBase implements Cloneable, JobEntryInterface {
	 ...
	 */
	private static Class<?> PKG = MonitorRDPJob.class; // for i18n purposes $NON-NLS-1$
	 ...
	 */
	public MonitorRDPJob(String name) {
		super(name, "");
	...
	public String getDialogClassName() {
		return MonitorRDPJobDialog.class.getName();
	}
	 ...
	 */
	public Object clone() {
		MonitorRDPJob je = (MonitorRDPJob) super.clone();
		return je;
	}

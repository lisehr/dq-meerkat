...
public class DQMkRDPStep extends BaseStep implements StepInterface {
	...
	public DQMkRDPStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {

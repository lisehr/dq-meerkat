  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      for (Concept c : ds.getConcepts()) {
        ...
        // when you create a new attribute, it is not automatically linked to the concept, despite having to specify the concept
        ...
        // however, the new attribute's datatype has to be specified, otherwise it causes a nullpointer exception
       ...
       // testing the newly created containsAttribute(String attribute) method
        ...
        for (Attribute a : c.getAttributes()) {
          ...
          System.out.println("Attribute: " + a.getDataType().toString() + "\t" + a.toString());
        }
        System.out.println();
      }

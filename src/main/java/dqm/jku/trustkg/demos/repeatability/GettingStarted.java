...
public class GettingStarted {
	...
	public static void main(String[] args) throws IOException, NoSuchMethodException {
		...
		// Create Connection to Supplychain dataset (once with CSV connector for repeatability; and once with MySQL connector as used for the demo)
//		ConnectorMySQL conn1 = ConnectorMySQL.getInstance("jdbc:mysql://localhost:3366/", "DataCo_Supplychain", args[0], args[1]);
		ConnectorCSV conn1 = new ConnectorCSV(Constants.RESSOURCES + "csv/DataCoSupplyChainDataset.csv", ",", "\n", "SupplyChain");
		
		// Create Connection to Tributech car engine data stream (once with CSV connector for repeatability; and once with Cassandra connector as used for the demo)
//		ConnectorCassandra conn2 = new ConnectorCassandra("bursa.scch.at", "Tributech-datastream", args[2], args[3]);
		ConnectorCSV conn2 = new ConnectorCSV(Constants.RESSOURCES + "csv/DataCoSupplyChainDataset.csv", ",", "\n", "CarEngineStream");
